...
export const sampleEmojis: EmojiEntry[] = [
  ...
  },
  {
    ...
    emoji: '🚗',
    category: 'objects',
    name: { fr: 'voiture', en: 'automobile' },
    keywords: { fr: ['voiture', 'auto', 'vehicule'], en: ['car', 'automobile', 'vehicle'] },
    codepoints: ['U+1F697'],
    supportsSkinTone: false,
  },
  {
    ...
    emoji: '🚙',
    category: 'objects',
    name: { fr: 'vehicule utilitaire sport', en: 'sport utility vehicle' },
    keywords: { fr: ['voiture', 'vehicule', 'suv'], en: ['car', 'vehicle', 'suv'] },
    codepoints: ['U+1F699'],
    supportsSkinTone: false,
  },
  {
